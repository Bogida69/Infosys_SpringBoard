...
video_detector.setModelPath(os.path.join(execution_path, r"C:\Drive E\me\Python_for_ML\Infosys\tiny-yolov3.pt"))
video_detector.loadModel()

# Define the output file name for the processed video
output_video_file_path = os.path.join(execution_path, r"C:\Drive E\me\Python_for_ML\Infosys\processed_video_output.mov")

# Process the video and save it to the specified output file
video_detector.detectObjectsFromVideo(
    input_file_path=os.path.join(execution_path, r"C:\Drive E\me\Python_for_ML\Infosys\00abd8a7-ecd6fc56.mov"),
