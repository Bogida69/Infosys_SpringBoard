...
cap = cv2.VideoCapture(r"C:\Drive E\me\Python_for_ML\Infosys\Infosys_SpringBoard\Input Video.mov")
...
output_video = cv2.VideoWriter(
    "videos/tracking_obj_video.avi", cv2.VideoWriter_fourcc(*"XVID"), fps, (frame_width, frame_height)
)
